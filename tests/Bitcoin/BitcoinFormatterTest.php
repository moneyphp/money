...
use Money\Bitcoin\BitcoinFormatter;
use Money\Currency;
use Money\Formatter\IntlMoneyFormatter;
use Money\Money;

final class BitcoinFormatterTest extends \PHPUnit_Framework_TestCase
{
    public function testRoundMoney()
    {
        ...
        $formatter = new BitcoinFormatter($intlFormatter, 2);
    ...
    public function testZeroFractionDigits()
    {
        ...
        $intlFormatter = new IntlMoneyFormatter($numberFormatter);
        $formatter = new BitcoinFormatter($intlFormatter, 0);
    ...
    public function testDifferentFractionDigits()
    {
        ...
        $intlFormatter = new IntlMoneyFormatter($numberFormatter);
        $formatter = new BitcoinFormatter($intlFormatter, 4);
